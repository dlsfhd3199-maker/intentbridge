...
const Context=createContext<{user:SessionUser;ready:boolean;qaSwitch:boolean;changeRole:(role:UserRole)=>void}>({user:mockUser("admin"),ready:false,qaSwitch:false,changeRole:()=>{}});
