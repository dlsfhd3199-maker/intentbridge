...
export const campaignChannels: CampaignChannel[] = [
  ...
  ...["naver", "google", "kakao", "daangn", "youtube", "affiliate", "crm", "other"].map(id => ({ id, name: ({ naver: "Naver", google: "Google", kakao: "Kakao", daangn:"Daangn", youtube: "YouTube", affiliate: "Affiliate", crm: "CRM", other: "Other" } as Record<string, string>)[id], source: true, retargeting: ["naver", "google", "kakao", "daangn", "other"].includes(id), capability: { status: "Coming Soon" as const, forecast: false, create: false }, previewLabel: "Mock Creative Preview", cpm: 0 })),
];
